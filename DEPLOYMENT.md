...
- **Login (Discord OAuth), wallet balance, quest claims, transaction history**
  — fully working, persisted in SQLite.
- **Species database** — served from `server/data/species.json`, real API-backed.
- **Live map / player positions, roster of owned dinos, leaderboards** — the
